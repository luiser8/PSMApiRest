...
namespace PSMApiRest.Controllers
{
    ...
    public class TercerosController : ApiController
    {
        ...
        [Route("update")]
        public IHttpActionResult PutIdentificador(string Id_Terceros, string Identificador, string Telefonos, string Emails)
        {
            try
            {
                return Ok(tercerosDAL.UpdateTerceros(Id_Terceros, Identificador, Telefonos, Emails));
            }
            catch (Exception ex)
            {
